    ...
    <div class="container">
        ...
        <div class="sign-content">
                    ...
                    <div class=" ">
                        <form action="" method="post" id="signup_form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" onblur="emailCheck()" name="checkCode" class="form-control"
                                       id="email-check" placeholder="请填写您的邮箱验证码">
                                <p onclick="checkEmailCode()" class="btn btn-info check-code">获取验证码</p>
                            </div><!--/.form-group -->
                            <div class="form-group">
                                <label for="password">新密码 <i class="password-warm"></i></label>
                                <input type="password" onblur="checkPwd()" name="upassword" class="form-control"
                                       id="password" placeholder="请填写您的密码">
                            </div><!--/.form-group -->
                            <div class="form-group">
                                <label for="repassword">确认密码 <i class="repassword-warm"></i></label>
                                <input type="password" onblur="checkRepwd()" class="form-control" id="repassword"
                                       placeholder="请确认您的密码">
                            </div><!--/.form-group -->
                        </form><!--/form -->
                    </div><!--/.col -->
            ...
            <div class="signin-footer">
                ...
                <p class="had-account">
                    <a href="${pageContext.request.contextPath}/login">回到登录</a>
                </p>
            </div><!--/.signin-footer -->
...
<footer class="footer-copyright">
    <div id="scroll-Top">
        <i class="fa fa-angle-double-up return-to-top" id="scroll-top" data-toggle="tooltip" data-placement="top"
           title="" data-original-title="Back to Top" aria-hidden="false"></i>
    </div><!--/.scroll-Top-->
