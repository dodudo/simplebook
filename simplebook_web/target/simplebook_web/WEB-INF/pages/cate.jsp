                ...
                <div class="layui-card-body ">
                    <table class="layui-table layui-form">
                        ...
                        <tr cate-id='1' fid='0' >
                            ...
                            <td class="td-manage">
                                <button class="layui-btn layui-btn layui-btn-xs"  onclick="xadmin.open('编辑','admin-edit.jsp')" ><i class="layui-icon">&#xe642;</i>编辑</button>
                                <button class="layui-btn layui-btn-warm layui-btn-xs"  onclick="xadmin.open('编辑','admin-edit.jsp')" ><i class="layui-icon">&#xe642;</i>添加子栏目</button>
